      ...
      <div className="max-w-5xl mx-auto px-6">
        <h2 className="text-3xl font-bold mb-12 flex items-center gap-3">
          ...
          <div className="relative animate-fade-up">
            <div className="absolute -left-10.25 top-0 w-5 h-5 rounded-full bg-primary border-4 border-black box-content"></div>
          ...
          <div className="relative animate-fade-up" style={{animationDelay: '0.2s'}}>
            <div className="absolute -left-10.25 top-0 w-5 h-5 rounded-full bg-gray-600 border-4 border-black"></div>
