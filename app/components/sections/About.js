    ...
    <section id="about" className="py-24 relative">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="relative group perspective-1000">
          ...
          <div className="relative rounded-2xl overflow-hidden border border-[var(--border-subtle)] aspect-[4/5] md:aspect-square transform transition-transform duration-500 group-hover:scale-[1.01] shadow-[var(--shadow-card)]" style={{ backgroundColor: 'var(--bg-surface)' }}>
        ...
        <div className="space-y-8 animate-fade-up">
          ...
          <div className="space-y-6 text-gray-400 text-lg leading-relaxed">
            ...
            <div className="p-4 border-l-2 border-primary rounded-r-lg" style={{ backgroundColor: 'rgba(255, 255, 255, 0.03)' }}><p className="text-sm italic text-gray-300">"My goal is to bridge the gap between academic theory and production reality."</p></div>
          </div>
        </div>
      </div>
    </section>
