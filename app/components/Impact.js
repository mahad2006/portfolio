  ...
  return (
    <section className="py-24 relative bg-black/40">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12"><h2 className="text-2xl font-bold text-white mb-2">Community Impact</h2><p className="text-gray-400">Verified feedback from peers and collaborators.</p></div>
        <div className="grid md:grid-cols-2 gap-6">
          <SpotlightCard className="p-8 rounded-2xl border border-white/5 bg-[#0a0a0a] relative flex flex-col">
            ...
            <div className="flex items-center gap-4 mt-auto"><div className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-xs font-bold text-white">NY</div><div className="flex-1"><div className="flex items-center gap-2"><p className="text-white font-bold text-sm">Nabeerah Yaqoot</p></div><p className="text-xs text-gray-400">Senior Student, UBIT</p></div></div>
          </SpotlightCard>
          <SpotlightCard className="p-8 rounded-2xl border border-white/5 bg-[#0a0a0a] relative flex flex-col">
              <span className="absolute top-4 left-6 text-6xl text-primary opacity-20 serif">"</span>
