    ...
    'scalable-ecommerce': (
      <div className="flex flex-col items-center gap-8 py-8">
        <div className="flex items-center gap-8 flex-wrap justify-center">
          ...
          {/* Arrow */}
          <svg className="w-12 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
          </svg>

          {/* Redis Cache */}
          <div className="flex flex-col items-center">
            <div className="px-8 py-6 border-2 rounded-lg font-mono text-sm font-bold transition-all bg-secondary-soft border-secondary-soft text-secondary">
              Redis Cache
            </div>
          ...
          {/* PostgreSQL */}
          <div className="flex flex-col items-center">
            <div className="px-8 py-6 bg-primary/10 border-2 border-primary/40 rounded-lg font-mono text-sm font-bold text-primary hover:border-primary transition-all">
              PostgreSQL
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-3xl mt-4">
          ...
          <div className="p-4 card-base rounded-lg">
            <div className="text-[10px] text-secondary font-mono uppercase tracking-wider mb-1">Latency Reduction</div>
    ...
    'derivify-calculus': (
      <div className="flex flex-col items-center gap-8 py-8">
        <div className="flex items-center gap-8 flex-wrap justify-center">
          ...
          {/* Lexer */}
          <div className="flex flex-col items-center">
            <div className="px-8 py-6 bg-secondary/10 border-2 border-secondary/40 rounded-lg font-mono text-sm font-bold text-secondary">
              Lexer
            </div>
          ...
          {/* Parser */}
          <div className="flex flex-col items-center">
            <div className="px-8 py-6 bg-primary/10 border-2 border-primary/40 rounded-lg font-mono text-sm font-bold text-primary">
              Parser
            </div>
      ...
      <div className="flex flex-col items-center gap-8 py-8">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex gap-16">
            <div className="flex flex-col items-center">
              <div className="text-xs text-primary font-mono mb-4">HIT (89%)</div>
              <div className="px-8 py-6 bg-primary/10 border-2 border-primary/40 rounded-lg font-mono text-sm font-bold text-primary">
                Return Cached
              </div>
            </div>
            <div className="flex flex-col items-center">
              ...
              <div className="px-6 py-4 border rounded font-mono text-xs bg-secondary-soft border-secondary-soft text-secondary">
                Update Cache
              </div>
            </div>
          </div>
