...
export default function Error({ error, reset }) {
    ...
    return (
        <div className="min-h-screen bg-page text-red-500 font-mono flex flex-col items-center justify-center p-6 text-center">
            <div className="border border-red-900/50 bg-red-900/10 p-8 rounded-xl max-w-lg w-full shadow-2xl shadow-red-900/20 backdrop-blur-sm">
                ...
                <p className="text-muted mb-2">Error Code: 0x500_INTERNAL_SERVER_ERROR</p>
