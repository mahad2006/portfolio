...
const project = projectsData.find(p => p.slug === 'scalable-ecommerce');
...
const ProjectPage = () => {
  ...
  return (
    <div className="min-h-screen bg-bg text-gray-300 font-mono selection:bg-primary selection:text-black">
      <nav className="fixed top-0 w-full z-50 bg-(--bg-page)/90 backdrop-blur-xl border-b border-(--border-subtle) px-6 py-4">
          ...
          <article className="md:col-span-2 space-y-12">
            ...
            <div>
              ...
              <div className="p-6 bg-neutral-900 border border-neutral-800 rounded-xl">
                {/* You can replace this with an <Image /> component or a Mermaid diagram */}
