...
const project = projectsData.find(p => p.slug === 'dsa-roadmap');
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 pt-32 pb-24">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <article className="md:col-span-2 space-y-12">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">Information Architecture</h2>
              <div className="p-6 bg-neutral-900 border border-neutral-800 rounded-xl">
                <div className="w-full h-64 bg-neutral-800 rounded-md flex items-center justify-center">
                  <p className="text-gray-500">[Diagram: Knowledge Hierarchy & Contribution Flow]</p>
                </div>
              </div>
