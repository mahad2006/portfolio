      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <a href="#" className="block p-8 rounded-2xl glass-panel hover:bg-white/[0.05] transition-all group relative overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-4"><span className="text-xs font-mono text-[#6DB33F]">Performance Engineering</span><div className="flex gap-2"><span className="text-xs text-gray-500">6 min read</span><span className="text-xs text-gray-500">Jan 2026</span></div></div>
            ...
            <a href="#" className="block p-8 rounded-2xl glass-panel hover:bg-white/[0.05] transition-all group">
              <div className="flex justify-between items-start mb-4"><span className="text-xs font-mono text-[#E76F00]">Databases</span><div className="flex gap-2"><span className="text-xs text-gray-500">4 min read</span><span className="text-xs text-gray-500">Jan 2026</span></div></div>
