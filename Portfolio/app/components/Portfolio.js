'use client'; // This is required for Next.js components that use useState/useEffect
            ...
            <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-gray-400">
                    {['About', 'Projects', 'Stack', 'Writing'].map((item) => (
                        <button key={item} onClick={() => scrollTo(item.toLowerCase())} className="hover:text-[#6DB33F] transition-colors relative group">
                            {item}
                            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#6DB33F] transition-all group-hover:w-full"></span>
                        </button>
                    ))}
            ...
            {mobileMenuOpen && (
                <div className="fixed inset-0 bg-black/95 z-40 flex flex-col items-center justify-center space-y-8 md:hidden animate-fade-up">
                    {['About', 'Projects', 'Stack', 'Writing', 'Connect'].map((item) => (
                        <button key={item} onClick={() => scrollTo(item.toLowerCase())} className="text-2xl font-bold text-white hover:text-[#6DB33F] transition-colors">
                            {item}
                        </button>
                    ))}
                </div>
    ...
    return (
        <header className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
            ...
            <div className="relative z-10 text-center px-6 max-w-5xl mx-auto animate-fade-up">
                <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full border border-[#6DB33F]/30 bg-[#6DB33F]/5 text-[#6DB33F] text-xs font-bold tracking-widest uppercase hover:bg-[#6DB33F]/10 transition-colors cursor-default hover:scale-105 transform duration-300">
                ...
                <p className="text-gray-400 text-lg md:text-xl italic max-w-2xl mx-auto mb-10 border-l-2 border-[#6DB33F] pl-4 bg-white/5 py-2 rounded-r-lg">
                ...
                <div className="h-8 mb-10 flex items-center justify-center">
                    <p className="mono text-xs md:text-sm text-[#6DB33F] opacity-80">
            ...
            <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div className="relative group perspective-1000">
                    ...
                    <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-black aspect-[4/5] md:aspect-square transform transition-transform duration-500 group-hover:scale-[1.01] shadow-2xl">
                        {/* Note: In Next.js, images in public folder are referenced from root like /profile.png */}
                        <img src="/profile.png" onError={(e) => { e.target.style.display = 'none'; e.target.nextSibling.style.display = 'flex'; }} alt="Shaikh Mahad" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" />
                        <div className="hidden w-full h-full absolute inset-0 bg-gradient-to-br from-gray-900 to-black flex-col items-center justify-center text-center p-8">
                            <span className="text-6xl mb-4">👨‍💻</span>
                            <p className="text-gray-500 text-xs mono">Profile.png</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-8 animate-fade-up">
                    <h2 className="text-3xl font-bold flex items-center gap-3">
                        <span className="text-[#6DB33F] mono text-2xl">01.</span> About Me
                    </h2>
                    <div className="space-y-6 text-gray-400 text-lg leading-relaxed">
                        <div>
                            <h3 className="text-white font-bold mb-2 text-xl">The Journey to Backend</h3>
                            <p>I started in native Android development, obsessing over user experience. But as I built more complex apps, I realized the real magic happens on the server. I shifted my focus to <span className="text-white">backend engineering</span> to build the robust systems that power great products.</p>
                        </div>
                        <div>
                            <h3 className="text-white font-bold mb-2 text-xl">How I Think</h3>
                            <p>I don't just write code; I design systems. I care deeply about <span className="text-white">data structures, memory efficiency, and the "why"</span> behind every architectural decision. Algorithms aren't just interview questions to me—they are the toolkit for scalability.</p>
                        </div>
                        <div className="p-4 bg-white/[0.03] border-l-2 border-[#6DB33F] rounded-r-lg">
                            <p className="text-sm italic text-gray-300">"My goal is to bridge the gap between academic theory and production reality."</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="philosophy" className="py-24 relative border-t border-white/5 bg-black/20">
            <div className="max-w-6xl mx-auto px-6">
                <div className="mb-12 md:text-center max-w-2xl mx-auto">
                    <h2 className="text-3xl font-bold mb-4"><span className="text-[#6DB33F] mono text-2xl">02.</span> Engineering Philosophy</h2>
                ...
                <div className="grid md:grid-cols-3 gap-6 animate-fade-up">
                    {[
                        { icon: "⚖️", title: "Trade-offs First", desc: "There is no 'perfect' architecture. I actively weigh consistency vs. availability, and latency vs. throughput." },
                        { icon: "🧱", title: "Simplicity Wins", desc: "Complexity is the enemy of reliability. I prefer boring, proven technologies over the latest hype." },
                        { icon: "🔍", title: "Root Cause Analysis", desc: "When things break, I don't just patch the bug. I dig deep to understand the systemic failure." }
                    ].map((item, idx) => (
    ...
    return (
        <div className={`group relative rounded-2xl glass-panel border border-white/5 hover:border-[#6DB33F]/40 transition-all duration-500 hover:shadow-[0_0_30px_rgba(109,179,63,0.1)] flex flex-col h-full overflow-hidden hover:-translate-y-2 ${isFlagship ? 'md:col-span-2 md:flex-row' : ''}`}>
            ...
            <div className={`${isFlagship ? 'md:w-1/2 h-64 md:h-full' : 'h-52 w-full'} bg-[#0a0a0a] border-b md:border-b-0 md:border-r border-white/5 relative overflow-hidden`}>
                {image ? (
                    <img src={image} alt={title} className="w-full h-full object-cover opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" onError={(e) => { e.target.style.display = 'none'; e.target.nextSibling.style.display = 'flex'; }} />
                ) : null}
                    ...
                    <div className="flex flex-wrap gap-2">
                        {filters.map(f => (
                            <button
                                key={f}
                                onClick={() => setFilter(f)}
                                className={`px-4 py-2 rounded-full text-xs font-mono border transition-all ${filter === f ? 'bg-[#6DB33F] text-black border-[#6DB33F]' : 'bg-transparent text-gray-500 border-white/10 hover:border-white/30'}`}
                            >
                                {f}
                            </button>
                        ))}
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <a href="#" className="block p-8 rounded-2xl glass-panel hover:bg-white/[0.05] transition-all group relative overflow-hidden">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed mb-4">
                            Exploring the trade-offs between Shunting-Yard algorithm and hand-written recursive descent parsers for mobile-constrained environments.
                        </p>
                    ...
                    <a href="#" className="block p-8 rounded-2xl glass-panel hover:bg-white/[0.05] transition-all group">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed mb-4">
                            A deep dive into handling concurrency in inventory management systems and when to use `@Version` annotations.
                        </p>
                        <div className="flex items-center text-sm font-bold text-white group-hover:translate-x-2 transition-transform">
                            Read Article <span className="ml-2">→</span>
                        </div>
        ...
        <section className="py-24 relative bg-black/40">
            <div className="max-w-6xl mx-auto px-6">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-500">Verified feedback from peers and collaborators.</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-8 rounded-2xl border border-white/5 bg-[#0a0a0a] relative flex flex-col">
                        ...
                        <p className="text-gray-300 text-lg italic leading-relaxed relative z-10 mb-6 flex-grow">
                            Mahad has a rare ability to dive deep into system internals while keeping the big picture in mind. His work on the DSA roadmap changed how our batch approached interviews.
                        </p>
                        <div className="flex items-center gap-4 mt-auto">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2">
                                    <p className="text-white font-bold text-sm">Nabeerah Yaqoot</p>
                                    <a href="#" className="text-blue-500 hover:text-blue-400"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect x="2" y="9" width="4" height="12" /><circle cx="4" cy="4" r="2" /></svg></a>
                                </div>
                                <p className="text-xs text-gray-500">Senior Student, UBIT</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-8 rounded-2xl border border-white/5 bg-[#0a0a0a] relative flex flex-col">
                        <span className="absolute top-4 left-6 text-6xl text-[#6DB33F] opacity-20 serif">"</span>
                        <p className="text-gray-300 text-lg italic leading-relaxed relative z-10 mb-6 flex-grow">
                            The offline-first architecture for the Chat App was executed with a level of maturity I rarely see in undergraduate projects. Clean, testable, and robust.
                        </p>
                        <div className="flex items-center gap-4 mt-auto">
                            <div className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-xs font-bold text-white">MK</div>
                            <div className="flex-1">
                                <div className="flex items-center gap-2">
                                    <p className="text-white font-bold text-sm">M. Khan</p>
                                    <a href="#" className="text-blue-500 hover:text-blue-400"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect x="2" y="9" width="4" height="12" /><circle cx="4" cy="4" r="2" /></svg></a>
                                </div>
                                <p className="text-xs text-gray-500">Project Collaborator</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="relative animate-fade-up">
                        ...
                        <div className="glass-panel p-8 rounded-xl hover:bg-white/[0.02] transition-colors">
                            <p className="text-gray-400 mb-4">
                                Established a student community to bridge the gap between academic theory and engineering reality.
                            </p>
            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-start">
                    <div className="space-y-6">
                        ...
                        <a href="mailto:codewithmahad@gmail.com" className="flex items-center gap-4 p-4 glass-panel rounded-lg hover:border-[#6DB33F] transition-all group hover:-translate-y-1">
                            <div className="p-3 bg-white/5 rounded-full group-hover:bg-[#6DB33F]/20 transition-colors"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-gray-400 group-hover:text-[#6DB33F]"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg></div>
                            <div><p className="text-sm text-gray-500">Email</p><p className="text-white font-mono text-sm group-hover:text-[#6DB33F] transition-colors">codewithmahad@gmail.com</p></div>
                        </a>
                ...
                <div className="border-t border-white/10 mt-20 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-500 mono">
                    <div className="flex flex-col gap-2 text-center md:text-left">
                        <p className="text-white font-bold text-lg tracking-tight">Shaikh Mahad.</p>
                        <p className="text-xs">Backend Systems Engineer • Karachi, PK</p>
                    </div>
                    <div className="flex gap-8">
                        <a href="#about" className="hover:text-[#6DB33F] transition-colors">About</a>
                        <a href="#projects" className="hover:text-[#6DB33F] transition-colors">Projects</a>
                        <a href="#writing" className="hover:text-[#6DB33F] transition-colors">Writing</a>
                    </div>
